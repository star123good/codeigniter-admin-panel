                  ...
                  <ul class="collection p-0">
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-7.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-1.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-off avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-2.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-3.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                           <h6 class="line-height-0">Caleb Richards</h6>
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-4.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-off avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-5.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-6.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-off avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-8.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-9.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-off avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-10.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-off avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-11.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
                     ...
                     <li class="collection-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                        <span class="avatar-status avatar-online avatar-50"
                           ><img src="<?=base_url("template/app-assets/images/avatar/avatar-12.png")?>" alt="avatar" />
                           <i></i>
                        </span>
                        <div class="user-content">
...
<!-- END RIGHT SIDEBAR NAV -->
    ...
    <footer class="page-footer footer footer-static footer-dark gradient-45deg-indigo-purple gradient-shadow navbar-border navbar-shadow">
      <div class="footer-copyright">
        <div class="container"><span>&copy; 2019          <a href="/" target="_blank">Chat Bot Admin</a> All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="/">Unknown</a></span></div>
      </div>
    </footer>