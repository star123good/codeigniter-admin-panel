...
<header class="page-topbar" id="header">
    ...
    <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
        ...
        <ul class="navbar-list right">
            ...
            <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="<?=base_url("template/app-assets/images/avatar/avatar-1.png")?>" alt="avatar"><i></i></span></a></li>
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    ...
    <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="/">
            <!-- <img src="<?=base_url("template/app-assets/images/logo/materialize-logo-color.png")?>" alt="materialize logo"/> -->
