...
<div class="card recent-buyers-card animate fadeUp">
   <div class="card-content">
	  ...
	  <ul class="collection mb-0">
		 <li class="collection-item avatar">
			<img src="<?=base_url("template/app-assets/images/avatar/avatar-7.png")?>" alt="" class="circle" />
		 ...
		 <li class="collection-item avatar">
			<img src="<?=base_url("template/app-assets/images/avatar/avatar-3.png")?>" alt="" class="circle" />
			<p class="font-weight-600">Adam Garza</p>
			<p class="medium-small">20, January 2019</p>
			<a href="#!" class="secondary-content"><i class="material-icons">star_border</i></a>
		 </li>
		 <li class="collection-item avatar">
			<img src="<?=base_url("template/app-assets/images/avatar/avatar-5.png")?>" alt="" class="circle" />
